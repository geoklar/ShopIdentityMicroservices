...
public static class UserClaims
{
    ...
    public const string Catalog_ReadAccess = "catalog.readaccess";
    public const string Catalog_FullAccess = "catalog.fullaccess";
    public const string Catalog_WriteAccess = "catalog.writeaccess";
    public const string Cart_ReadAccess = "cart.readaccess";
    public const string Cart_FullAccess = "cart.fullaccess";
    public const string Cart_WriteAccess = "cart.writeaccess";
